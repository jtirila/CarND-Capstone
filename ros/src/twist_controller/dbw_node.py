...
class DBWNode(object):
    def __init__(self):
        ...
        self.controller = Controller(vehicle_mass, brake_deadband, decel_limit, wheel_radius, accel_limit ,wheel_base, steer_ratio, min_speed, max_lat_accel, max_steer_angle)
...
if __name__ == '__main__':
    rospy.logdebug("Starting DBWNode() function")
    DBWNode()
